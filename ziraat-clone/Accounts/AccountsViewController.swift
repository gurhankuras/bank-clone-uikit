...
class AccountsViewController: UIViewController {
    ...
    deinit {
        print("AccountsViewController deinit")
    }
...
/*
 ...
 scrollView.addSubview(accountImageView)
 ...
 scrollView.addSubview(accountBranchNameLabel)
 ...
 scrollView.addSubview(allMyAccountsButton)
 ...
 let dummyContent3 = UIView()
 dummyContent3.backgroundColor = .blue

 contentView.addSubview(dummyContent3)
 dummyContent3.snp.makeConstraints { make in
     make.leading.trailing.equalTo(contentView)
     make.top.equalTo(allMyAccountsButton.snp.bottom)
     make.bottom.equalTo(contentView.layoutMarginsGuide.snp.bottomMargin)
