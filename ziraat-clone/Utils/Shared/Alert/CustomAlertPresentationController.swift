...
class CustomAlertPresentationController: UIPresentationController {
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier!, category: String(describing: "CustomAlertPresentationController"))
...
/*
extension CustomAlertPresentationController: UIAdaptivePresentationControllerDelegate {
