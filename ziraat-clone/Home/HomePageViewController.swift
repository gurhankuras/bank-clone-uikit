...
extension HomePageViewController {
    private func configureNavigationBar() {
        ...
        // MARK: bar left item
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "power"), style: .done,
        ...
        // MARK: bar right item
        navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "bell"), style: .done,
                                                            target: self, action: #selector(exit))
